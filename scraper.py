...
# The 2026 Hit List (Highest converting/most searched AI companions)
ai_companions = [
    ...
    {"name": "Character.ai", "subreddit": "CharacterAI", "base_score": 500, "url": "https://character.ai/?ref=YOUR_AFFILIATE_ID", "description": "The mainstream giant. High traffic, heavy filters."},
    {"name": "Kupid AI", "subreddit": "KupidAI", "base_score": 450, "url": "https://kupid.ai/?ref=YOUR_AFFILIATE_ID", "description": "High conversational quality with voice and video integration."},
    {"name": "DreamGF", "subreddit": "DreamGF", "base_score": 400, "url": "https://dreamgf.ai/?ref=YOUR_AFFILIATE_ID", "description": "Heavy focus on customized visual companion creation."},
    {"name": "Replika", "subreddit": "replika", "base_score": 300, "url": "https://replika.com/?ref=YOUR_AFFILIATE_ID", "description": "The original mainstream AI companion. Emotional focus."},
    {"name": "Kindroid", "subreddit": "KindroidAI", "base_score": 150, "url": "https://kindroid.ai/?ref=YOUR_AFFILIATE_ID", "description": "Unfiltered, highly intelligent text generation."},
    {"name": "Nomi AI", "subreddit": "NomiAI", "base_score": 100, "url": "https://nomi.ai/?ref=YOUR_AFFILIATE_ID", "description": "Incredibly natural personality traits and retention."}
]
